 ...
 * @author DERECHO
 */
public class Pet3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        breedA.setFont(new java.awt.Font("Candara", 0, 14)); // NOI18N
        breedA.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        breedA.setText("boss");
        jPanel24.add(breedA, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 90, 50, 20));

        genA.setFont(new java.awt.Font("Candara", 0, 14)); // NOI18N
        genA.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        genA.setText("female");
        jPanel24.add(genA, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 40, 20));
        ...
        n.setFont(new java.awt.Font("Candara", 1, 16)); // NOI18N
        n.setText("Name:");
        jPanel24.add(n, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, -1, -1));

        nameLabel.setFont(new java.awt.Font("Candara", 0, 14)); // NOI18N
        nameLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        nameLabel.setText("boss");
        jPanel24.add(nameLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 30, 50, 20));

        ageA.setFont(new java.awt.Font("Candara", 0, 14)); // NOI18N
        ageA.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ageA.setText("boss");
        jPanel24.add(ageA, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 50, 20));

        jPanel13.add(jPanel24);
        jPanel24.setBounds(10, 40, 660, 650);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pet3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pet3().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel ageA;
    private javax.swing.JLabel breedA;
