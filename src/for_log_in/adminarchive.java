...
public class adminarchive extends javax.swing.JFrame {
    ...
    public adminarchive() {
     ...
     public void displayUser() {
        try {
            String query = "SELECT c_id, c_name, c_age, c_gender, c_contact, c_address, c_email FROM tbl_archived_customers";
            archivestable.setModel(DbUtils.resultSetToTableModel(connector.getData(query)));
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        archivestable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
